pipeline {
    ...
    environment {
        ...
        ORGANIZATION_NAME = "tcv"

        // Name of repository, application, etc..
        REPOSITORY_NAME = "frontend-app"

        // Staging server information
        STAGING_VM_IP = "178.128.51.42"
        STAGING_URL = "https://app-staging.tcvault.xyz"
        STAGING_DOCKER_PORT = 80
        STAGING_DOCKER_BIND_PORT = 3110
        STAGING_ENV_CREDENTIALS_ID = 'env-staging-tcv-app'

        // Production server information
        PRODUCTION_VM_IP = "178.128.51.42"
        PRODUCTION_URL = "https://app.tcvault.xyz"
        PRODUCTION_DOCKER_PORT = 80
        PRODUCTION_DOCKER_BIND_PORT = 3100
        PRODUCTION_ENV_CREDENTIALS_ID = 'env-production-tcv-app'
