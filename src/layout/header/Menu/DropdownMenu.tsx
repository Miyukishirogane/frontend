...
function DropdownMenu({ listNestMenu, defaultTitle }: DropdownMenuCheckProps) {
  ...
  const currPath = useMemo(() => {
    return listNestMenu.find(item => pathname.includes(item.url));
  }, [listNestMenu, pathname]);
