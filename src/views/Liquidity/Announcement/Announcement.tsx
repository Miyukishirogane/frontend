...
import BlurBox from './Icons/BlurBox';
import Coin1 from './Icons/Coin1';
import Coin2 from './Icons/Coin2';
import GoldPaper from './Icons/GoldPaper';
import GoldPaper2 from './Icons/GoldPaper2';
  ...
  return (
    ...
    >
      <Box sx={{ width: '100%', ml: { md: 6, xs: 2 }, zIndex: 2, position: 'relative', m: 'auto' }}>
        ...
        >
          Add Liquidity, Claim Multiple Rewards
        </Typography>
        {displayUserRank()}
        {/* <Box sx={{ display: 'flex', alignItems: 'center', mt: { md: 3, xs: 1 } }} style={{ cursor: 'pointer' }}>
          <a target="_blank" href={'https://docs.tcvault.xyz/'} style={{ color: 'unset', textDecoration: 'none' }}>
