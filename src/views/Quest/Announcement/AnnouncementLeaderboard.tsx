...
export default function AnnouncementLeaderboard() {
  ...
  return (
    ...
    >
      ...
      >
        <Box
          component="img"
          src={imagePath.QuestLeaderboardBanner}
          sx={{
            m: 'auto',
            mb: 0,
            transform: 'translateX(25%)',
            background: 'radial-gradient(46.24% 46.24% at 50% 50%, #80D2FF 37.39%, rgba(43, 128, 232, 0) 100%)',
          }}
          alt="tcv_quest_leaderboard_banner"
        />

        <QuestBannerIcon src={imagePath.QuestBannerCoin1} sx={{ left: '55%', bottom: '13%', width: '120px' }} />
        <QuestBannerIcon
          src={imagePath.QuestBannerCoin1}
          sx={{ right: '32%', top: '13%', opacity: 0.6, rotate: '0', width: '100px' }}
        />
        <QuestBannerIcon
          src={imagePath.QuestBannerCoin1}
          sx={{ right: '3%', bottom: '13%', opacity: 0.6, rotate: '260deg', width: '100px' }}
        />
