export const abiVaultLending = [
  ...
  },
  {
    ...
    name: 'removeAddressIndexMapping',
    outputs: [
      {
        internalType: 'bool',
        name: 'success',
